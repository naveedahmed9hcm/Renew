...
<div className="">
    <div className="row">
        <div className="col-md-6">
            ...
            <label className='labels'>Countries</label>
        ...
        options={ mydatas.map((Mdata) => ({
          value: Mdata.CountryId,
          label: Mdata.Countryname,
        }))}
      /> */}
...
<button onClick={() => { handlePostData(); navigate("/Designation"); }} type='submit' className='Tbtn'>Save</button>
</div>
</div>
   </div>
    </div>
